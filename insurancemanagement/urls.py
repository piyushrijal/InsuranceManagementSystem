...
from insurance.views import MyLoginView
...
urlpatterns = [
    ...
    path('login', MyLoginView.as_view(template_name='insurance/adminlogin.html'), name='adminlogin'),
    ...
    path('admin-view-waiting-policy-holder', views.admin_view_waiting_policy_holder_view,
